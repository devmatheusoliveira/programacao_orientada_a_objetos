...
class DialogCalibrarPorTipoWidget extends StatefulWidget {
  final Function(String value) onChanged1;
  final Function(String value) onChanged2;

  const DialogCalibrarPorTipoWidget({
    Key? key,
  ...
  @override
  State<DialogCalibrarPorTipoWidget> createState() =>
      _DialogCalibrarPorTipoWidgetState();
}

class _DialogCalibrarPorTipoWidgetState
    extends State<DialogCalibrarPorTipoWidget> {
